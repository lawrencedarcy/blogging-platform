...
/* harmony import */ var _Feed_module_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Feed.module.css */ "./components/Feed/Feed.module.css");
/* harmony import */ var _Feed_module_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_Feed_module_css__WEBPACK_IMPORTED_MODULE_3__);
...
function Feed(_ref) {
  ...
  var addPosts = function addPosts() {
    return numPosts = (Object(_babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_0__["default"])("numPosts"), numPosts + 10);
  };
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(sortedList),
  ...
  }), feedState === 'list' && __jsx(_FeedHeader__WEBPACK_IMPORTED_MODULE_4__["default"], {
    filter: 'list',
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }), __jsx(react_infinite_scroll_component__WEBPACK_IMPORTED_MODULE_5__["default"], {
    dataLength: 8 //This is important field to render the next data
    ,
    next: posts,
    hasMore: true,
    loader: __jsx("h4", {
  ...
  }, sortedList.slice(0).map(function (post) {
    return __jsx("div", {
      className: _Feed_module_css__WEBPACK_IMPORTED_MODULE_3___default.a.feed_card,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 46,
...
//# sourceMappingURL=index.js.150622c8d3a2b773cd43.hot-update.js.map