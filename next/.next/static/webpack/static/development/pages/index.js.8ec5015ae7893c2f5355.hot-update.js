...
function Card(_ref) {
  ...
  function check() {
    return checkReadingList(user, post._id);
  }
  ...
  return __jsx("div", {
    ...
    className: !isClicked ? _Card_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.card_btn : _Card_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.card_btn_clicked,
    onClick: function onClick() {
      return clickHandler();
    },
    __self: this,
  ...
  }, !isClicked || checkReadingList(user, post._id) ? '📚 Save' : '📚 Saved')));
}
...
//# sourceMappingURL=index.js.8ec5015ae7893c2f5355.hot-update.js.map