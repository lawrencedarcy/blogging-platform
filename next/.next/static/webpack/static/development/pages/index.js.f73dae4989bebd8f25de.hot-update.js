...
function Card(_ref) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(auth.isLoading),
      userLoading = _useState2[0],
      setUserLoading = _useState2[1];

  console.log(auth); // checkReadingList(user, post._id);
  ...
  }, "\uD83D\uDCDA Remove") : !isLoading && checkReadingList(user, post._id)(__jsx("div", {
...
//# sourceMappingURL=index.js.f73dae4989bebd8f25de.hot-update.js.map