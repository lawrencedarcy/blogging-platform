...
function Post(_ref) {
  ...
  }, post.title), post.img_url && __jsx("img", {
    src: post.img_url,
    alt: post.title,
    "class": "article_img",
    __self: this,
