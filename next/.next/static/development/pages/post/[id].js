...
// Module
exports.push([module.i, "\n\n.Footer_footer_wrapper__1jiLN {\n \n  max-width: inherit;\n  height: 3rem;\n  margin: auto;\n  position: fixed;\n  left: 10%;\n  bottom: 1.4%;\n  width: 80%;\n  \n}\n\n@media only screen and (min-width: 1200px) {\n  .Footer_footer_wrapper__1jiLN  {\n    width: 60%;\n    position: fixed;\n  left: 20%;\n  bottom: 1.4%;\n  }\n}\n\n.Footer_footer__2hIWU {\n  background-color: #6ecdfd;\n  height: 3.6rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1rem 3rem;\n  \n\n}\n\n.Footer_footer_upvote__DJDup, .Footer_footer_upvote_clicked__1rtlm, .Footer_footer_share__v23DR, .Footer_footer_discuss__2vCCg  {\n  color: white;\n  cursor: pointer;\n  border: 1px solid white;\n  padding: .4rem .8rem;\n  font-size: .9rem;\n  border-radius: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  min-width: 80px;\n}\n\n.Footer_footer_share__v23DR {\n\n  height: 2.8rem;\n  \n}\n\n.Footer_tweet_link__2PhHZ {\n\n  color: white;\n  padding: 0 0 0 .4rem;\n\n}\n.Footer_footer_share__v23DR:hover {\n\n}\n\n\n.Footer_footer_upvote_clicked__1rtlm {\n  background-color: #9efd6e;\n  cursor: default;\n}\n\n.Footer_footer_upvote__DJDup:hover, .Footer_footer_share__v23DR:hover, .Footer_footer_discuss__2vCCg:hover {\n  border: 1px solid #9efd6e;\n  transform: scale(1.1);\n}\n\n.Footer_votes_wrapper__2MqJa {\n  display: flex;\n}\n\n.Footer_footer_votes__1YFBn {\n  color: white;\n}\n\n.Footer_footer_logo__1dJsI{\n  width: 30px;\n  display: block;\n  margin: 0rem;\n}\n\n@media only screen and (max-width: 400px) {\n  .Footer_footer_upvote__DJDup, .Footer_footer_share__v23DR {\n    font-size: .8rem;\n    \n  }\n}\n\n@media only screen and (max-width: 400px) {\n  .Footer_footer__2hIWU{\n    padding: 1rem 1rem;\n\n    overflow: none;\n}}", "",{"version":3,"sources":["/Users/lawrence_wakefield/Documents/Development/codeworks/final-project/blogging-platform/next/components/Article/Footer/Footer.module.css"],"names":[],"mappings":";;AAEA;;EAEE,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,eAAe;EACf,SAAS;EACT,YAAY;EACZ,UAAU;;AAEZ;;AAEA;EACE;IACE,UAAU;IACV,eAAe;EACjB,SAAS;EACT,YAAY;EACZ;AACF;;AAEA;EACE,yBAAyB;EACzB,cAAc;EACd,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,kBAAkB;;;AAGpB;;AAEA;EACE,YAAY;EACZ,eAAe;EACf,uBAAuB;EACvB,oBAAoB;EACpB,gBAAgB;EAChB,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,eAAe;AACjB;;AAEA;;EAEE,cAAc;;AAEhB;;AAEA;;EAEE,YAAY;EACZ,oBAAoB;;AAEtB;AACA;;AAEA;;;AAGA;EACE,yBAAyB;EACzB,eAAe;AACjB;;AAEA;EACE,yBAAyB;EACzB,qBAAqB;AACvB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,cAAc;EACd,YAAY;AACd;;AAEA;EACE;IACE,gBAAgB;;EAElB;AACF;;AAEA;EACE;IACE,kBAAkB;;IAElB,cAAc;AAClB,CAAC","file":"Footer.module.css","sourcesContent":["\n\n.footer_wrapper {\n \n  max-width: inherit;\n  height: 3rem;\n  margin: auto;\n  position: fixed;\n  left: 10%;\n  bottom: 1.4%;\n  width: 80%;\n  \n}\n\n@media only screen and (min-width: 1200px) {\n  .footer_wrapper  {\n    width: 60%;\n    position: fixed;\n  left: 20%;\n  bottom: 1.4%;\n  }\n}\n\n.footer {\n  background-color: #6ecdfd;\n  height: 3.6rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1rem 3rem;\n  \n\n}\n\n.footer_upvote, .footer_upvote_clicked, .footer_share, .footer_discuss  {\n  color: white;\n  cursor: pointer;\n  border: 1px solid white;\n  padding: .4rem .8rem;\n  font-size: .9rem;\n  border-radius: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  min-width: 80px;\n}\n\n.footer_share {\n\n  height: 2.8rem;\n  \n}\n\n.tweet_link {\n\n  color: white;\n  padding: 0 0 0 .4rem;\n\n}\n.footer_share:hover {\n\n}\n\n\n.footer_upvote_clicked {\n  background-color: #9efd6e;\n  cursor: default;\n}\n\n.footer_upvote:hover, .footer_share:hover, .footer_discuss:hover {\n  border: 1px solid #9efd6e;\n  transform: scale(1.1);\n}\n\n.votes_wrapper {\n  display: flex;\n}\n\n.footer_votes {\n  color: white;\n}\n\n.footer_logo{\n  width: 30px;\n  display: block;\n  margin: 0rem;\n}\n\n@media only screen and (max-width: 400px) {\n  .footer_upvote, .footer_share {\n    font-size: .8rem;\n    \n  }\n}\n\n@media only screen and (max-width: 400px) {\n  .footer{\n    padding: 1rem 1rem;\n\n    overflow: none;\n}}"]}]);
// Exports
exports.locals = {
...
/* harmony import */ var _components_SideBar_Article_Sidebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../components/SideBar/Article_Sidebar */ "./components/SideBar/Article_Sidebar.js");
...
function Post(_ref) {
  ...
  }, __jsx(disqus_react__WEBPACK_IMPORTED_MODULE_5__["DiscussionEmbed"], {
    shortname: "stagetime",
    config: ({
      url: post.id
    }, {
